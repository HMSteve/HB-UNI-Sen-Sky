...
template <uint8_t I2C_ADDR> class Sens_MAX44009 : public Sensor {
    ...
    uint32_t _brightnessLux1000;    // scaled bei 1000

public:
    Sens_MAX44009()
        : _brightnessLux1000(0)
    {
    }
        ...
        if (_present == true) {
            ...
            if (Wire.requestFrom(I2C_ADDR, (uint8_t)1, (uint8_t)0) == 1) {    // Repeated START
                ...
                if (Wire.requestFrom(I2C_ADDR, (uint8_t)1, (uint8_t)1) == 1) {
                    ...
                    _brightnessLux1000 = (uint32_t)floor(1000.0 * lux);
                    DPRINT(F("MAX44009 Brightness x1000: "));
                    DDECLN(_brightnessLux1000);
                    return true;
                }
            }
        }
    ...
    uint32_t brightnessLux() { return _brightnessLux1000; }
};
